...
int usbDeviceIoControl (AmlUsbDrv *drv, unsigned int control_code, void *in_buf, unsigned int in_len, void *out_buf,
    unsigned int out_len, unsigned int *in_data_size, unsigned int *out_data_size);
int usbDeviceIoControlEx (AmlUsbDrv *drv, unsigned int controlCode, void *in_buf, unsigned int in_len, void *out_buf,
    unsigned int out_len, unsigned int *in_data_size, unsigned int *out_data_size,
...
int Aml_Libusb_Ctrl_RdWr(void *device, unsigned int offset, char *buf, unsigned int len, unsigned int readOrWrite, unsigned int timeout);
